...
public partial class page_signup : System.Web.UI.Page
{
    ...
    {
        conn.Open();
        SqlCommand ins = new SqlCommand("insert into users(uUsername,uPassword,uSex,uBirthday,stuNum,name,university,uState) values(@username,@password,@usex,@birthday,@stunum,@name,@university,0)", conn);
