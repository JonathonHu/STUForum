<%@ Page Title="" Language="C#" MasterPageFile="~/page/admin/MasterPage.master" AutoEventWireup="true" CodeFile="deladmin.aspx.cs" Inherits="page_admin_deladmin" %>
...
<div class="form-group col-lg-5 col-lg-offset-1">
    <asp:TextBox runat="server" ID="username" type="text" style="margin-top:5px;" class=" form-control input-lg col-lg-6 "  placeholder="新输入要删除用户名"/>
